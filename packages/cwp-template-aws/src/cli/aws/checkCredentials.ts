import { createBeforeDeployPlugin } from "@webiny/cli-plugin-deploy-pulumi/plugins";
import { STS } from "@webiny/aws-sdk/client-sts";
import { green } from "chalk";

export const checkCredentialsHook = createBeforeDeployPlugin(async ({ inputs }, context) => {
...
checkCredentialsHook.name = "hook-before-deploy-aws-credentials";
